// TODO: check if the bf (balkon befahrbar) value comes correct to the backend
...
// Custom checkbox component for "Balkon oder Fenster befahrbar?" - no validation needed
function BalconyAccessCheckbox({ name }: { name: string }) {
  const t = useTranslations();
  ...
  return (
    <div className={styles.checkboxWrapper}>
      <label className={styles.checkboxLabel}>
        ...
        />
        <span className={styles.checkboxText}>{t("pl.bf")}</span>
      </label>
    </div>
  );
}

export default function ModernMoebelliftForm() {
  const t = useTranslations();
  ...
  return (
    <FormContainer
      title={pageTitle}
      icon={<Construction size={40} color="#274c88" strokeWidth={1.5} />}
    >
        ...
        <div className={styles.form__group}>
          <div className={styles.form__groupLeft}>
            ...
            <ModernFormInput
              ...
              required
              errors={getFieldErrors("eostrasse")}
              onValidationChange={handleValidationChange}
            />
            <ModernFormInput
              name="eoland"
            ...
            <ModernFormInput
              ...
              type="text"
              placeholder={t("pl.et")}
              errors={getFieldErrors("eoet")}
              onValidationChange={handleValidationChange}
            />
            <BalconyAccessCheckbox name="bf" />
          </div>

          <div className={styles.form__groupRight}>
            {/* Empty right column as shown in the screenshot */}
          </div>
        </div>
